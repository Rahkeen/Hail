...
class FakeWeatherRepository : WeatherRepository {
    override suspend fun getWeather(): WeatherFeed {
       return fakeWeatherFeed
    }
}

class NoNetworkWeatherRepository : WeatherRepository {
    override suspend fun getWeather(): WeatherFeed {
        throw Exception("No Network")
    }
}

class EmptyWeatherRepository : WeatherRepository {
    override suspend fun getWeather(): WeatherFeed {
        return emptyWeatherFeed
    }
}

private val fakeWeatherFeed = WeatherFeed(
...
private val emptyWeatherFeed = WeatherFeed(
    title = "Empty",
